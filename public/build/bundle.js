...
var app = (function () {
    ...
    /* src/components/Todos.svelte generated by Svelte v3.38.2 */
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*itemLength*/ 1) set_data_dev(t0, /*itemLength*/ ctx[0]);
    		},
    ...
    function create_each_block(key_1, ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[5](/*todo*/ ctx[8]);
    	}

    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[6](/*todo*/ ctx[8]);
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*$todos*/ 2 && input_id_value !== (input_id_value = /*todo*/ ctx[8].id)) {
    				attr_dev(input, "id", input_id_value);
    			}

    			if (!current || dirty & /*$todos*/ 2 && label_for_value !== (label_for_value = /*todo*/ ctx[8].id)) {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!li_transition) li_transition = create_bidirectional_transition(li, slide, { duration: 600, easing: cubicInOut }, true);
    				li_transition.run(1);
    			});
    		...
    		o: function outro(local) {
    			if (!li_transition) li_transition = create_bidirectional_transition(li, slide, { duration: 600, easing: cubicInOut }, false);
    			li_transition.run(0);
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*itemLength*/ ctx[0] == undefined || /*itemLength*/ ctx[0] == 0) return create_if_block;
    		if (/*itemLength*/ ctx[0] >= 1) return create_if_block_1;
    	}
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(form, "submit", prevent_default(/*addTodo*/ ctx[2]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$todos, deleteTodo, cubicInOut, toggleDone*/ 26) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const addTodo = event => {
    		...
    		$$invalidate(0, itemLength = $todos.length);
    	};

    	const toggleDone = id => {
    		const index = $todos.findIndex(item => item.id === id);
    		set_store_value(todos, $todos[index].checked = !$todos[index].checked, $todos);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("itemLength" in $$props) $$invalidate(0, itemLength = $$props.itemLength);
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "A small collection with to-do's";
    			t3 = space();
    			create_component(todos.$$.fragment);
    			attr_dev(h1, "class", "app-title svelte-17p1jnl");
    			add_location(h1, file, 6, 2, 84);
    			attr_dev(p, "id", "undertitle");
    			attr_dev(p, "class", "svelte-17p1jnl");
    			add_location(p, file, 7, 2, 124);
    			add_location(div, file, 5, 1, 76);
    			attr_dev(main, "class", "svelte-17p1jnl");
